...
struct RoomConversationView: View {
        ...
        ZStack {
            ...
            VStack {
                ...
                HStack {
                    Spacer()
                    Button {
                        let userMessage = UserMessage.create(in: viewContext, text: newText, room: room, destBot: targetBot)
                        messages.append(userMessage.toMessage())
    ...
    private func buildMessages(userMessage: String, to bot: Bot) -> [ChatMessage] {
